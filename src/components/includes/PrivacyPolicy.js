...
export default function PrivacyPolicy (){
    ...
    return(
        <>
        <section className='innerbanner-sec terms-bnr'>            
    ...
    <section className="personal personal_mm">
        <div className="container">
            <div className="row">
                <div className="col-md-12">
                    ...
                    <div className="newsle">
                        ...
                        <p>In any event, any deposited funds for a project shall not be subject to refund after delivery if the initial design concepts are approved, or a change is requested unless National Logo Designs cancels or terminates your Contract for a reason other than your breach or non-performance.</p>
                    </div>
                    <div className="newsle">
                        ...
                        <ul>
                            ...
                            <li>For website packages no refund will be entertained once website development has been started  or once the website has been deployed live.</li>
                            <li>For video animation packages no refund request will be entertained after the designing of the storyboard.</li>
                            <li>  All refund requests should be communicated to the support department. National Logo Designs, based on the violation of your user agreement reserves the right to approve/disapprove your request on an individual case to case basis. </li>
                            <li>  For National Logo Designs, refund will be applicable the same as it is on the single packages.
                            </li>
                            <li>  For example, if you order logo and web design service and approve the logo, you can claim refund for the website service at the time of initial design only.(Refund will be prorated based on the bundle discount). </li>
                    ...
                    <div className="newsle">
                        ...
                        <strong>To assure your refund request is approved, please make sure you meet the following requirements</strong>
                        <ul>
                            <li>Claim your refund specifying your concern by contacting us via any of the following three modes:
                                <ul>
                                    <li>Toll free # 866-712-0210            </li>
                                    <li>Live Chat
                                    </li>
                                    <li><a href="mailto:info@nationallogodesigns.com">support@nationallogodesigns.com </a></li>
                                </ul>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                We will try to resolve your concern by virtue of our revision policy immediately or else will email you a refund request approval from our refund department. After the refund, your design rights would be obtained by National Logo Designs and you would not be able to display any version of the design sent by company. Let us also specify that:
                                <ul>
                                    <li>
                    ...
                    <div className="newsle">
                        ...
                        <p>In order to provide you the desired satisfaction, our designers don't deviate from the specifications provided by you in the order form.</p>
                        <p>The designs are created after a thorough research which ensures the design quality and uniqueness.</p>
                    </div>
                    <div className="newsle">
                    ...
                    <div className="newsle">
                        ...
                        <p>There is no refund for the hosting, domain or email server package</p>
                    </div>
                    <div className="newsle">
                    ...
                    <div className="newsle">
                        ...
                        <p>We keep a record of your finalized design once we provide you the final files.</p>
                        <p>If you require the final files again in the future we can send them to you at your request.</p>
                    </div>
                    <div className="newsle">
                    ...
                    <div className="newsle">
                        ...
                        <p>YOU agree that National Logo Designs is not liable for any correspondence from email address (es) other than the ones followed by our own domain i.e. "..<a href="">@nationallogodesigns.com </a>" or/and any toll free number that is not mentioned on our website. National Logo Designs should not be held responsible for any damage(s) caused by such correspondence. We only take responsibility of any communication through email address (es) under our own domain name or/and via toll free number i.e. already mentioned on National Logo Designs Website.</p>
                    </div>
                    <div className="newsle">
                        <h3>Access to Information</h3>
                        <p>To access National Logo Designs services you may be asked to provide certain registration details or other information. By accepting these terms &amp; conditions, you hereby acknowledge that all the information provided by you will be correct, current, and complete. If National Logo Designs believes the information that you have provided is not correct, current, or complete, National Logo Designs has the right to refuse your access to any services or any of its resources, and to terminate or suspend your account at any time.</p>
                        <p>National Logo Designs is operating under a PCI DSS compliant company; therefore it is authorized to keep your credit card information on file that can be used for any recurring service, additional development hours, server or network equipment required to develop or launch your website without any prior notification. However, our representatives always bring this in knowledge so that you are aware about all the processes.</p>
                    </div>
                    <div className="newsle">
                        <h3>100% Unique Design Guarantee</h3>
                        <p>At National Logo Designs we guarantee that all of our customers' logos are made from scratch. This way you will have a logo that is tailor made for your requirements. We guarantee that your logo will be unique and impress your clientele</p>
                    </div>
                    <div className="newsle">
                        <h3>Exclusions</h3>
